...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('images', '0001_initial'),
        ('countries', '0046_auto_20171215_0921'),
    ]

    operations = [
        migrations.CreateModel(
            name='CountryCustomisableArticles',
            fields=[
        ...
        migrations.CreateModel(
            name='CountryCustomisablePartners',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('sort_order', models.IntegerField(blank=True, editable=False, null=True)),
                ('background_hex', models.CharField(blank=True, max_length=7, null=True)),
        ...
        migrations.AddField(
            model_name='countrycustomisablepartners',
            name='page',
            field=modelcluster.fields.ParentalKey(on_delete=django.db.models.deletion.CASCADE, related_name='partners_customisation', to='countries.CountryPage'),
        ),
        migrations.AddField(
            model_name='countrycustomisablearticles',
            name='page',
            field=modelcluster.fields.ParentalKey(on_delete=django.db.models.deletion.CASCADE, related_name='articles_customisation', to='countries.CountryPage'),
        ),
    ]
