...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('solutions', '0030_auto_20171115_1127'),
    ]
    ...
    operations = [
        migrations.AlterField(
            ...
            name='hero_logo',
            field=models.ForeignKey(blank=True, help_text='Shows the brand logo on the hero instead of a text heading.', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='+', to='images.CustomImage', verbose_name='Brand Logo'),
        ),
        migrations.AlterField(
            model_name='solutionpage',
            name='hero_strapline',
