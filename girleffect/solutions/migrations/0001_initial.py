# -*- coding: utf-8 -*-
# Generated by Django 1.11.3 on 2017-08-10 15:31
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('page', modelcluster.fields.ParentalKey(on_delete=django.db.models.deletion.CASCADE, related_name='related_documents', to='solutions.SolutionPage')),
            ],
            options={
                'abstract': False,
                'ordering': ['sort_order'],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('source_page', modelcluster.fields.ParentalKey(on_delete=django.db.models.deletion.CASCADE, related_name='related_pages', to='solutions.SolutionPage')),
            ],
            options={
                'abstract': False,
                'ordering': ['sort_order'],
